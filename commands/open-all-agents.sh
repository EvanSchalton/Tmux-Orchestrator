...
echo ""
echo "💬 DIRECT PM COMMUNICATION:"
echo "   - Message PM (non-interfering): VS Code task '💬 Message Project Manager'"
echo "   - Alternative: .tmux-orchestrator/commands/message-pm.sh 'your message'"
