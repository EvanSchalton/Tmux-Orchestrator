        ...
        for target, messages in messages_by_target.items():
            ...
            batch_message = {
                ...
                "metadata": {
                    ...
                    "tags": ["monitoring", "batch", "low_priority"]
                }
            }
