...
class IdleMonitorWithPubsub:
    ...
    def __init__(self, tmux: TMUXManager, config: Config, logger: logging.Logger):
        ...
        self.pubsub = MonitorPubsubIntegration(
    ...
    def check_fresh_agent(
        ...
        is_fresh = (
            "Welcome to Claude" in content or
            "I'll help you" in content and len(content.split('\n')) < 20 or
            content.strip().endswith("Human:") and len(content.split('\n')) < 10
        )
    ...
    def check_agent_crash(
        ...
        for indicator, crash_type in crash_indicators.items():
            if indicator in content:
                ...
                self.pubsub.publish_agent_crash(
                    agent,
                    crash_type,
                    session_name,
    ...
    def check_recovery_needed(
        ...
        self.pubsub.publish_recovery_needed(
            agent,
            issue,
            session_name,
    ...
    def _send_idle_notification(
        ...
        """
        self.pubsub.publish_agent_idle(
            agent,
            idle_duration,
            session_name,
            idle_type
    ...
    def handle_rate_limit(
        ...
        self.pubsub.publish_rate_limit(
            session_name,
            reset_time,
            agents
        )
