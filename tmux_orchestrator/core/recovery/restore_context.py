...
def _build_context_message(
    ...
    base_message: str = f"""RECOVERY NOTICE: You have been automatically restarted at {timestamp}.

You are an agent in the Tmux Orchestrator system working on: {target}
