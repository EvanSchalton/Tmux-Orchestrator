...
def start(ctx: click.Context, interval: int, supervised: bool, json: bool) -> None:
    ...
    if supervised:
        ...
        try:
            ...
            return  # Exit here without attempting fallback
    else:
        # Legacy mode - direct start with proper exception handling
        try:
            pid = monitor.start(interval)
            ...
            # No fallback - daemon startup failed for a real reason
