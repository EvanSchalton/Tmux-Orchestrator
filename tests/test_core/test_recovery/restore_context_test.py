...
class TestRestoreContext:
    """Test suite for restore_context function."""

    def test_restore_context_success(self) -> None:
    ...
    def test_restore_context_send_message_failure(self) -> None:
    ...
    def test_restore_context_invalid_target_format(self) -> None:
    ...
    def test_restore_context_with_context_data(self) -> None:
    ...
    def test_restore_context_exception_handling(self) -> None:
...
class TestBuildContextMessage:
    """Test suite for _build_context_message function."""

    def test_build_context_message_basic(self) -> None:
    ...
    def test_build_context_message_with_context_data(self) -> None:
    ...
    def test_build_context_message_contains_timestamp(self) -> None:
    ...
    def test_build_context_message_empty_context_data(self) -> None:
