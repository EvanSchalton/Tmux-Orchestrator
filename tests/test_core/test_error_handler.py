...
class TestErrorHandler:
    ...
    @pytest.fixture
    def error_handler(self, temp_log_dir: Path) -> ErrorHandler:
        """Create error handler with temp directory."""
        return ErrorHandler(log_dir=temp_log_dir)

    def test_error_classification(self, error_handler: ErrorHandler) -> None:
    ...
    def test_handle_error_basic(self, error_handler: ErrorHandler) -> None:
    ...
    def test_handle_critical_error(self, error_handler: ErrorHandler) -> None:
    ...
    def test_error_logging(self, error_handler: ErrorHandler, temp_log_dir: Path) -> None:
    ...
    def test_handle_errors_decorator(self) -> None:
    ...
    def test_handle_errors_decorator_critical(self) -> None:
    ...
    def test_retry_on_error_all_fail(self) -> None:
    ...
    def test_clear_error_messages(self, temp_log_dir: Path) -> None:
    ...
    def test_error_context_additional_info(self, error_handler: ErrorHandler) -> None:
    ...
    def test_recovery_procedures_setup(self, error_handler: ErrorHandler) -> None:
