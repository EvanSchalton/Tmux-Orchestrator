...
class TestAgentStateDetection:
    ...
    def test_detect_active_state(self):
    ...
    def test_detect_active_from_starting(self):
    ...
    def test_bash_prompt_is_crashed(self):
...
class TestUnsubmittedMessageDetection:
    ...
    def test_thinking_state_no_message(self):
...
class TestChangeDistance:
    ...
    def test_minor_length_difference(self):
...
class TestCrashIndicators:
    """Test _has_crash_indicators function."""

    def test_command_not_found_is_crash(self):
    ...
    def test_traceback_is_crash(self):
        """Test Python traceback is detected as crash."""
        content = "Traceback (most recent call last):\n  File..."
        assert _has_crash_indicators(content) is True

    def test_normal_content_not_crash(self):
...
class TestErrorIndicators:
    """Test _has_error_indicators function."""
...
class TestIntegration:
    ...
    def test_crashed_agent_full_flow(self):
    ...
    def test_idle_agent_full_flow(self):
    ...
    def test_message_queued_full_flow(self):
