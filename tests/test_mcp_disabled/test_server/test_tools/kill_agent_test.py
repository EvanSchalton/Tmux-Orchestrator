...
def test_kill_agent_invalid_target_format(mock_tmux) -> None:
...
def test_kill_agent_session_not_found(mock_tmux) -> None:
...
def test_kill_agent_graceful_shutdown_success(mock_tmux, mock_logger) -> None:
...
def test_kill_agent_force_kill(mock_tmux, mock_logger) -> None:
...
def test_kill_agent_with_pm_notification(mock_tmux, mock_logger) -> None:
...
def test_kill_agent_pane_target(mock_tmux, mock_logger) -> None:
...
def test_kill_agent_kill_fails(mock_tmux, mock_logger) -> None:
...
def test_kill_agent_unexpected_error(mock_tmux) -> None:
...
def test_kill_agent_graceful_shutdown_timeout(mock_tmux, mock_logger) -> None:
