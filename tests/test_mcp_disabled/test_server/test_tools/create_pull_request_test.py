...
def test_create_pull_request_empty_title() -> None:
...
def test_create_pull_request_empty_base_branch() -> None:
...
def test_create_pull_request_empty_head_branch() -> None:
...
def test_create_pull_request_not_on_branch() -> None:
...
def test_create_pull_request_uncommitted_changes() -> None:
...
def test_create_pull_request_successful() -> None:
...
def test_create_pull_request_with_quality_checks() -> None:
...
def test_create_pull_request_quality_checks_fail() -> None:
...
def test_create_pull_request_draft_mode() -> None:
...
def test_create_pull_request_with_labels() -> None:
...
def test_get_pr_status_successful() -> None:
...
def test_get_pr_status_not_found() -> None:
...
def test_link_pr_to_tasks_successful() -> None:
...
def test_link_pr_to_tasks_partial_failure() -> None:
...
def test_run_quality_checks_for_pr_successful() -> None:
...
def test_create_pull_request_gh_not_installed() -> None:
...
def test_create_pull_request_with_assignees() -> None:
...
def test_create_pull_request_exception_handling() -> None:
...
def test_create_pull_request_various_body_formats(body_content: str) -> None:
