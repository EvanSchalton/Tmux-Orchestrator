...
def test_monitor_routes_exist(client) -> None:
...
def test_messages_routes_exist(client) -> None:
...
def test_coordination_routes_exist(client) -> None:
...
def test_agents_routes_exist(client) -> None:
...
def test_tasks_routes_exist(client) -> None:
...
def test_invalid_json_handling(client) -> None:
...
def test_missing_route_404(client) -> None:
...
def test_openapi_endpoints(client) -> None:
