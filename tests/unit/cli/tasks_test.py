...
def test_tasks_create_new_project(runner, temp_orchestrator_dir) -> None:
...
def test_tasks_create_with_prd_import(runner, temp_orchestrator_dir) -> None:
...
def test_tasks_create_existing_project(runner, temp_orchestrator_dir) -> None:
...
def test_tasks_status(runner, temp_orchestrator_dir) -> None:
...
def test_tasks_status_nonexistent_project(runner, temp_orchestrator_dir) -> None:
...
def test_tasks_list(runner, temp_orchestrator_dir) -> None:
...
def test_tasks_distribute(runner, temp_orchestrator_dir) -> None:
...
def test_tasks_export(runner, temp_orchestrator_dir) -> None:
...
def test_tasks_archive(runner, temp_orchestrator_dir) -> None:
...
def test_tasks_generate(runner, temp_orchestrator_dir) -> None:
...
def test_tasks_group_exists() -> None:
