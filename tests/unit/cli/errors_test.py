...
def test_errors_group_help(runner: CliRunner) -> None:
...
def test_summary_no_errors(runner: CliRunner, mock_error_handler: Mock) -> None:
...
def test_summary_with_errors(runner: CliRunner, mock_error_handler: Mock) -> None:
...
def test_summary_json_output(runner: CliRunner, mock_error_handler: Mock) -> None:
...
def test_recent_no_errors(runner: CliRunner, mock_error_handler: Mock) -> None:
...
def test_recent_with_errors(runner: CliRunner, mock_error_handler: Mock) -> None:
...
def test_recent_with_filters(runner: CliRunner, mock_error_handler: Mock) -> None:
...
def test_clear_command(runner: CliRunner) -> None:
    """Test clear command."""
...
def test_clear_dry_run(runner: CliRunner) -> None:
...
def test_clear_no_files(runner: CliRunner) -> None:
...
def test_stats_no_errors(runner: CliRunner, mock_error_handler: Mock) -> None:
...
def test_stats_with_errors(runner: CliRunner, mock_error_handler: Mock) -> None:
