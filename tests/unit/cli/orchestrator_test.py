...
def test_orchestrator_start_new_session(runner, mock_tmux) -> None:
...
def test_orchestrator_start_existing_session(runner, mock_tmux) -> None:
...
def test_orchestrator_kill(runner, mock_tmux) -> None:
...
def test_orchestrator_kill_not_running(runner, mock_tmux) -> None:
...
def test_orchestrator_restart_via_kill_and_start(runner, mock_tmux) -> None:
...
def test_orchestrator_status_running(runner, mock_tmux) -> None:
...
def test_orchestrator_status_not_running(runner, mock_tmux) -> None:
...
def test_orchestrator_list(runner, mock_tmux) -> None:
...
def test_orchestrator_broadcast(runner, mock_tmux) -> None:
...
def test_orchestrator_group_exists() -> None:
