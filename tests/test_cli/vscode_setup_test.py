...
def test_vscode_setup_help(runner: CliRunner) -> None:
...
def test_vscode_command_help(runner: CliRunner) -> None:
...
def test_vscode_setup_creates_tasks_json(runner: CliRunner) -> None:
...
def test_vscode_setup_minimal_mode(runner: CliRunner) -> None:
...
def test_vscode_setup_existing_file_no_force(runner: CliRunner) -> None:
...
def test_vscode_setup_custom_project_dir(runner: CliRunner) -> None:
...
def test_workspace_command(runner: CliRunner) -> None:
...
def test_workspace_command_custom_name(runner: CliRunner) -> None:
...
def test_extensions_command(runner: CliRunner) -> None:
...
def test_config_command(runner: CliRunner) -> None:
...
def test_config_command_interactive(runner: CliRunner) -> None:
...
def test_generated_tasks_structure(runner: CliRunner) -> None:
