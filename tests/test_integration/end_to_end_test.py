...
def test_complete_prd_workflow(runner, mock_tmux, temp_orchestrator_home) -> None:
...
def test_task_management_workflow(runner, mock_tmux, temp_orchestrator_home) -> None:
...
def test_team_deployment_and_recovery(runner, mock_tmux) -> None:
...
def test_monitoring_workflow(runner, mock_tmux) -> None:
...
def test_agent_communication_workflow(runner, mock_tmux) -> None:
...
def test_project_archival_workflow(runner, mock_tmux, temp_orchestrator_home) -> None:
