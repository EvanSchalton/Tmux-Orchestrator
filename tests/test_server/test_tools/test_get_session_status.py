...
def mock_tmux():
    ...
    mock._is_idle.return_value = True
    return mock


class TestGetSessionStatus:
    """Test get_session_status function."""

    def test_get_session_status_success(self, mock_tmux):
    ...
    def test_get_session_status_empty(self, mock_tmux):
    ...
    def test_get_session_status_with_mixed_agent_statuses(self, mock_tmux):
        ...
        mock_tmux.list_sessions.return_value = [
            {"name": "proj", "attached": "0", "windows": "5", "created": "2024-01-01"}
        ]
        mock_tmux.list_agents.return_value = mock_agents
    ...
    def test_get_session_status_tmux_failure(self, mock_tmux):
    ...
    def test_get_session_status_agents_failure(self, mock_tmux):
        """Test session status when agent listing fails."""
        mock_tmux.list_sessions.return_value = [
            {"name": "test", "attached": "0", "windows": "1", "created": "2024-01-01"}
        ]
...
class TestGetAgentStatus:
    ...
    def test_get_agent_status_success(self, mock_tmux):
    ...
    def test_get_agent_status_idle_agent(self, mock_tmux):
    ...
    def test_get_agent_status_empty_session_name(self, mock_tmux):
    ...
    def test_get_agent_status_empty_window_name(self, mock_tmux):
    ...
    def test_get_agent_status_whitespace_names(self, mock_tmux):
    ...
    def test_get_agent_status_session_not_found(self, mock_tmux):
    ...
    def test_get_agent_status_capture_failure(self, mock_tmux):
    ...
    def test_get_agent_status_with_custom_lines(self, mock_tmux):
        ...
        assert result.output_length == 1  # One long line with \\n characters
        # The output is one big string, but recent_output gets last 10 split lines
        assert len(result.recent_output) == 1  # One big string
        assert "Line 50" in result.recent_output[0]

        # Verify custom line count was passed
        mock_tmux.capture_pane.assert_called_once_with("test:agent", lines=200)

    def test_get_agent_status_empty_output(self, mock_tmux):
    ...
    def test_agent_status_request_defaults(self):
    ...
    def test_agent_status_result_dataclass(self):
    ...
    def test_session_status_result_dataclass(self):
