...
def test_get_agent_status_include_activity_history(mock_tmux, temp_activity_file) -> None:
    ...
    assert metrics.activity_history and len(metrics.activity_history) == 3
...
def test_get_agent_status_blocked_agent_from_activity(mock_tmux, temp_activity_file) -> None:
    ...
    assert metrics.activity_tags and "blocked" in metrics.activity_tags
    assert metrics.activity_tags and "api" in metrics.activity_tags
