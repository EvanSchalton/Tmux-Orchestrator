...
def test_handoff_work_empty_from_agent() -> None:
    """Test handoff_work with empty from_agent returns error."""
    tmux = Mock(spec=TMUXManager)
    request = HandoffWorkRequest(from_agent="", to_agent="dev:1", work_description="Complete authentication feature")
...
def test_handoff_work_empty_to_agent() -> None:
    """Test handoff_work with empty to_agent returns error."""
    tmux = Mock(spec=TMUXManager)
    request = HandoffWorkRequest(from_agent="dev:0", to_agent="", work_description="Complete authentication feature")
...
def test_handoff_work_empty_work_description() -> None:
...
def test_handoff_work_invalid_from_agent_format() -> None:
...
def test_handoff_work_invalid_to_agent_format() -> None:
...
def test_handoff_work_same_agent() -> None:
...
def test_handoff_work_from_agent_not_found() -> None:
...
def test_handoff_work_to_agent_not_found() -> None:
...
def test_handoff_work_successful_basic_handoff() -> None:
...
def test_handoff_work_successful_with_context_preservation() -> None:
...
def test_handoff_work_send_keys_failure() -> None:
...
def test_handoff_work_with_additional_notes() -> None:
...
def test_handoff_work_long_work_description() -> None:
...
def test_handoff_work_long_notes() -> None:
...
def test_handoff_work_invalid_priority() -> None:
...
def test_handoff_work_capture_pane_exception() -> None:
...
def test_handoff_work_context_truncation() -> None:
...
def test_handoff_work_all_valid_priorities(priority: str) -> None:
...
def test_handoff_work_message_formatting() -> None:
...
def test_handoff_work_cross_session_handoff() -> None:
...
def test_handoff_work_metadata_tracking() -> None:
