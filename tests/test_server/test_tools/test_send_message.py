...
class TestSendMessage:
    ...
    def test_send_message_success(self, mock_tmux):
        """Test successful message sending."""
        request = SendMessageRequest(
            target="myproject:Claude-PM", message="Please work on the login feature", urgent=False
        )
    ...
    def test_send_message_urgent(self, mock_tmux):
    ...
    def test_send_message_failure(self, mock_tmux):
    ...
    def test_send_message_exception(self, mock_tmux):
    ...
    def test_send_message_empty_target(self, mock_tmux):
    ...
    def test_send_message_empty_message(self, mock_tmux):
    ...
    def test_send_message_whitespace_target(self, mock_tmux):
    ...
    def test_send_message_whitespace_message(self, mock_tmux):
        """Test sending whitespace-only message."""
        request = SendMessageRequest(target="test:agent", message="   \\t\\n   ", urgent=False)

        result = send_message(mock_tmux, request)

        # The actual implementation only checks .strip(), so whitespace passes through
        assert result.success is True
        assert result.message_sent == "   \\t\\n   "

    def test_send_message_long_message(self, mock_tmux):
    ...
    def test_send_message_special_characters(self, mock_tmux):
    ...
    def test_send_message_multiline(self, mock_tmux):
...
Each line should be preserved."""
    ...
    def test_send_message_result_dataclass(self):
    ...
    def test_send_message_result_with_error(self):
        """Test SendMessageResult with error."""
        result = SendMessageResult(
            success=False, target="broken:target", message_sent="", error_message="Target not found"
        )
    ...
    def test_send_message_complex_target_format(self, mock_tmux):
    ...
    def test_send_message_invalid_target_formats(self, mock_tmux):
