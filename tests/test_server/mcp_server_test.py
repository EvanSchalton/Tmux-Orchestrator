...
def test_app_with_middleware() -> None:
...
def test_server_routes_registration() -> None:
...
def test_server_error_handling() -> None:
...
def test_server_info_endpoint() -> None:
...
def test_full_server_startup() -> None:
